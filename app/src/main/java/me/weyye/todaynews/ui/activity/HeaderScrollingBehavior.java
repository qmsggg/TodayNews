...
public class HeaderScrollingBehavior extends CoordinatorLayout.Behavior<RecyclerView> {
    ...
    public boolean layoutDependsOn(CoordinatorLayout parent, RecyclerView child, View dependency) {
        if (dependency != null && dependency.getId() == R.id.ivScrollingHeader) {
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, RecyclerView child, View dependency) {
        Logger.i("onDependentViewChanged");
...
//        Logger.i("onNestedPreScroll--dy:" + dy+"---newTranslateY:"+newTranslateY+"---minHeaderTranslate:"+minHeaderTranslate);
        if (newTranslateY > minHeaderTranslate) {
//            Logger.i("onNestedPreScroll 消费了");
    ...
    public void onNestedScroll(CoordinatorLayout coordinatorLayout, RecyclerView child, View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed) {
        ...
        View dependentView = getDependentView();
        Logger.i("dxUnconsumed:" + dxUnconsumed+"--dependentView.getTranslationY():"+dependentView.getTranslationY());
